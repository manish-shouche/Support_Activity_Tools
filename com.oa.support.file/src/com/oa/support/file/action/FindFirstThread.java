...
/**
 * This class executes the Find First in a file Action in a separate thread
 */
public class FindFirstThread extends Thread {
	...
	public FindFirstThread() {

	}

	public FindFirstThread(FileHandlerAction action, byte[] arry, ActionDetails ad, byte[] lastThrdRemain) {
		this.act = action;
		this.actDetails = ad;
		this.bArray = arry;
