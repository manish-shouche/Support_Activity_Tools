...
/**
 * This class executes the Find All in a File Action
 */
public class FindAllAction extends FileHandlerAction {
	...
	public FileHandlerActionResult execute(FileDetails fd, ActionDetails ad) throws Exception {
		...
		while ((nRead = rbch.read(bb)) != -1) {
			...
			if (threadList.size() > 0) {
				lastThrd = (FindAllThread) threadList.getLast();
			}
			...
			FindAllThread thread = new FindAllThread(this, bbArray, ad, this.lastThrdRemaining);
